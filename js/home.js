...
$('.titre2').click(function(){
	...
	// Hide
	mainToPlaylist.to($('#titre'), 0.8, {display: 'none', opacity: 0, scale: 1.1, ease: Power2.easeInOut}, 0)
...
/////////////////////////////////
///////////////////////////////////
// fonction playlist menu

$('.nav_link_playlist').click(function(){
	
	var homeToMain = new TimelineMax({});
	// Hide
	
	$('.dim').css('display', 'none', 'opacity', '0'),
	$('.nav').css('display', 'none', 'transform', 'translate(-100%, 0%) matrix(1, 0, 0, 1, 0, 0)'),
	homeToMain.to($('.line, .text-wrap'), 0.5, {display: 'none', opacity: 0, y: -20, ease: Power2.easeInOut}, 0),
